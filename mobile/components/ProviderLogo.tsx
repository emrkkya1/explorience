...
export function ProviderLogo({ provider, size = 24 }: ProviderLogoProps) {
  if (provider === 'gemini') {
    return (
      <Svg width={size} height={size} viewBox="0 0 65 65">
        <Defs>
          <LinearGradient id="gemini-logo-grad" x1="18.447" y1="43.42" x2="52.153" y2="15.004" gradientUnits="userSpaceOnUse">
        ...
        <Path d={GEMINI_PATH} fill="url(#gemini-logo-grad)" />
      </Svg>
    );
  }
  ...
  // OpenAI Compatible — green checkmark circle placeholder.
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path
        d="M12 2a10 10 0 100 20 10 10 0 000-20zm-1 14.5l-4-4 1.4-1.4L11 13.7l5.6-5.6L18 9.5l-7 7z"
        fill="#10A37F"
      />
    </Svg>
  );
